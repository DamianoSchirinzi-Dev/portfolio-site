...
export default function BlogCard(props: BlogCardProps) {
  return (
      <a className="flex flex-col gap-8 overflow-hidden bg-white rounded shadow-lg w-6/7 sm:w-3/4 lg:w-1/4 hover:animate-pulse text-custom_dark" href={`/blog/${props.slug}`}>
        <Image
          className="w-full"
          src={props.imagePath}
          width={200}
